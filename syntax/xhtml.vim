...
"----------
"[img] tag
nnoremap <buffer> ;im O<img src="" alt="" height="" width="" /><Esc>7F"i
vnoremap <buffer> ;im <Esc>`>a" alt="" height="" width="" /><Esc>`<i<a src="<Esc>l
inoremap <buffer> ;im <img src="" alt="" height="" width="" /><Esc>7F"i
if has("gui")
 nnoremenu XHtml.Image<Tab>;im O<img src="" alt="" height="" width="" /><Esc>7F"i
 vnoremenu XHtml.Image<Tab>;im <Esc>`>a" alt="" height="" width="" /><Esc>`<i<a src="<Esc>l
 inoremenu XHtml.Image<Tab>;im <img src="" alt="" height="" width="" /><Esc>7F"i
endif
"----------
"[br] tag
...
vnoremap <buffer> ;ul <Esc>`>o</ul><Esc>:'<,'>s/^\(\s*\)\(.*\)$/\1 <li>\2<\/li>/<CR>`<O<BS><ul><Esc>
